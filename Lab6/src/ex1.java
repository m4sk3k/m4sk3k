...
public class ex1 {
    public static void main(String[] args) throws IOException {
        ...
        try {
            in = new FileReader("C:\\Users\\m4sk\\IdeaProjects\\Lab6\\MyFile1.txt"); // файл для чтения
            out= new FileWriter("C:\\Users\\m4sk\\IdeaProjects\\Lab6\\MyFile2.txt", true); // файл для записи
